...
impl GetBlockVerboseOne {
    ...
    pub fn into_model(
        self,
    ) -> Result<model::GetBlockVerboseOne, GetBlockVerboseOneError> {
...
impl GetBlockVerboseTwo {
    ...
    pub fn into_model(
        self,
    ) -> Result<model::GetBlockVerboseTwo, GetBlockVerboseTwoError> {
...
impl GetBlockVerboseThree {
    ...
    pub fn into_model(
        self,
    ) -> Result<model::GetBlockVerboseThree, GetBlockVerboseThreeError> {

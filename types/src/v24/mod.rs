...
pub use crate::{
    ...
    v21::{
        AddPeerAddress, GenerateBlock, GetBlockStats, GetBlockStatsError, GetIndexInfo,
        GetIndexInfoName, GetNetworkInfo, GetRawMempoolSequence, ImportDescriptors,
        ImportDescriptorsResult, PsbtBumpFee, PsbtBumpFeeError, Send, SendError, SendMany,
        SendManyVerbose, UnloadWallet, UpgradeWallet,
    },
    v22::{
